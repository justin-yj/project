...
$(function () {
    ...
    //列表
    $(".bannerRightTab ul li").mouseover(
       function(){
        $(".bannerRightTab ul li").removeClass("active");
        $(".bannerRightTab ul li").eq($(this).index()).addClass('active');
        $(".bannerRightList").hide();
        $(".bannerRightList").eq($(this).index()).show();
       }
    )
